    ...
    sections: [
      {
        ...
        body: `${siteConfig.siteName} is an independent fan guide for ${siteConfig.gameName}. It is built to help players find structured information about calculators, codes, tier-list research, beginner guidance, updates, and wiki notes without presenting unverified claims as facts.`
      },
      {
      ...
      },
      {
        ...
        body: `Active codes, rewards, calculator formulas, rankings, patch notes, and official claims should not be published as verified unless supporting evidence exists. Community-reported information must stay clearly labeled.`
      },
      {
        heading: "Contact",
  ...
  editorialPolicy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Tier lists, calculator pages, update pages, and wiki notes should explain whether information is verified, community-reported, or pending. The template must not invent formulas, rewards, patch notes, DPS, crate odds, or official rankings.`
      },
      {
